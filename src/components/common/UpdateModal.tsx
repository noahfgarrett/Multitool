          ...
          updated ? (
            ...
            <>
              <div className="flex items-center gap-3">
                ...
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-[#14B8A6]/20 text-[#14B8A6]">
                  v{info.version}
                </span>
              </div>
        ...
        {activeTab === 'changelog' && (
          <div className="space-y-3">
            ...
            {!showAll && changelogWithUpdate.length > INITIAL_VISIBLE && (
              <button
                type="button"
                className="text-xs text-[#14B8A6] hover:text-[#14B8A6]/80 transition-colors"
