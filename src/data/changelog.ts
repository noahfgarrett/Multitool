...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '4.8.4',
    date: '2026-08-04T19:17:07Z',
    type: 'fix',
    stats: { features: 2, fixes: 1, tools: 1 },
    notes: `### Org Chart
- Click-to-edit hierarchy connectors
- Editable chart color key
- Reliable custom chart backgrounds
- Color key included in exports`,
  },
  {
    version: '4.8.3',
    date: '2026-08-04T14:37:27Z',
    type: 'fix',
...
- Reliable color and popover controls`,
  },
  {
    ...
    stats: { fixes: 1 },
    notes: `### Updates
- Update downloads no longer fail`,
  },
  {
    version: '4.8.1',
    date: '2026-07-06T13:06:16Z',
    type: 'fix',
...
- Visible pages load first`,
  },
  {
    ...
    type: 'fix',
    stats: { fixes: 3, tools: 2 },
    notes: `### OCR
- Better scanned PDF search
- Sharper OCR word matching
- Improved Text Extract OCR layout`,
  },
  {
    version: '4.7.1',
    date: '2026-06-26T17:54:19Z',
    type: 'fix',
...
- Page no longer drifts when pinch-zooming on tablets`,
  },
  {
    ...
    stats: { fixes: 1 },
    notes: `### PDF Annotate
- Page stays put when pinch-zooming (no jump)`,
  },
  {
    version: '4.6.3',
    date: '2026-06-09T14:19:39Z',
    type: 'fix',
    stats: { fixes: 1 },
    notes: `### PDF Annotate
- Pinch-to-zoom now works on iPads`,
  },
  {
    version: '4.6.2',
    date: '2026-06-09T13:37:21Z',
    type: 'fix',
    stats: { fixes: 1 },
    notes: `### PDF Annotate
- Pinch-to-zoom fixed on iPads`,
  },
  {
    version: '4.6.1',
    date: '2026-06-09T13:02:12Z',
    type: 'fix',
    stats: { fixes: 1 },
    notes: `### PDF Annotate
- Smoother pinch-to-zoom on tablets`,
  },
  {
    version: '4.6.0',
